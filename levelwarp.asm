...
.set_next_object_desc:
  ...
  xdef       level_warp_powerups
; sets all powerup-variables for the level to start at specific screen (where screen means every ScreenWidth chunk)
...
.next_powerup_desc_loop:
  ...
  ble.s      .set_next_powerup_desc
  add.l      #pup_size,a0
  cmp.l      ig_om_end_powerup_desc(a4),a0
  bne.s      .next_powerup_desc_loop
.set_next_powerup_desc:
